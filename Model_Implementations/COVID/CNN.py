...
df3_Word2Vec_CNN_pred = best_model.predict(data_test)
df3_Word2Vec_CNN_pred_classes = np.argmax(df3_Word2Vec_CNN_pred, axis=1) if activations != 'sigmoid' else np.where(df3_Word2Vec_CNN_pred > 0.5, 1, 0)

# Evaluate performance on the test set
test_accuracy = accuracy_score(df3_test_class, df3_Word2Vec_CNN_pred_classes)
print("Test Accuracy: %.2f%%" % (test_accuracy * 100))

# Save predictions and model
np.savetxt("df3_Word2Vec_CNN_pred.csv", df3_Word2Vec_CNN_pred_classes, delimiter=",")
joblib.dump(best_model, 'df3_Word2Vec_CNN.sav')
...
# Predict on the test set
df3_Glove_CNN_pred = best_model.predict(data_test)
df3_Glove_CNN_pred_classes = np.argmax(df3_Glove_CNN_pred, axis=1) if activations != 'sigmoid' else np.where(df3_Glove_CNN_pred > 0.5, 1, 0)

# Evaluate performance on the test set
test_accuracy = accuracy_score(df3_test_class, df3_Glove_CNN_pred_classes)
print("Test Accuracy: %.2f%%" % (test_accuracy * 100))

# Save predictions and model
np.savetxt("df3_Glove_CNN_pred.csv", df3_Glove_CNN_pred_classes, delimiter=",")
joblib.dump(best_model, 'df3_Glove_CNN.sav')
...
# Predict on the test set
df3_Fasttext_CNN_pred = best_model.predict(data_test)
df3_Fasttext_CNN_pred_classes = np.argmax(df3_Fasttext_CNN_pred, axis=1) if activations != 'sigmoid' else np.where(df3_Fasttext_CNN_pred > 0.5, 1, 0)

# Evaluate performance on the test set
test_accuracy = accuracy_score(df3_test_class, df3_Fasttext_CNN_pred_classes)
print("Test Accuracy: %.2f%%" % (test_accuracy * 100))
