...
df3_Word2Vec_BiLSTM_pred = best_model.predict(data_test)
df3_Word2Vec_BiLSTM_pred_binary = np.where(df3_Word2Vec_BiLSTM_pred > 0.5, 1, 0)

# Evaluate performance on the test set
test_accuracy = accuracy_score(df3_test_class, df3_Word2Vec_BiLSTM_pred_binary)
print("Test Accuracy: %.2f%%" % (test_accuracy * 100))

# Save predictions and model
np.savetxt("df3_Word2Vec_BiLSTM_pred.csv", df3_Word2Vec_BiLSTM_pred_binary, delimiter=",")

# Save the best model using Keras' model saving
best_model.save("df3_Word2Vec_BiLSTM.h5")
...
# Save the best model using Keras' model saving
best_model.save("df3_Glove_BiLSTM.h5")
...
# Predict on the test set
df3_Fasttext_BiLSTM_pred = best_model.predict(data_test)
df3_Fasttext_BiLSTM_pred_binary = np.where(df3_Fasttext_BiLSTM_pred > 0.5, 1, 0)

# Evaluate performance on the test set
test_accuracy = accuracy_score(df3_test_class, df3_Fasttext_BiLSTM_pred_binary)
print("Test Accuracy: %.2f%%" % (test_accuracy * 100))

# Save predictions and model
np.savetxt("df3_Fasttext_BiLSTM_pred.csv", df3_Fasttext_BiLSTM_pred_binary, delimiter=",")

# Save the best model using Keras' model saving
best_model.save("df3_Fasttext_BiLSTM.h5")
...
torch.save(model.state_dict(), "df3_ELMO_BiLSTM.pth")
...
# Save the best model using PyTorch's model saving
torch.save(model.state_dict(), "df3_BERT_BiLSTM.pth")
...
# Save the best model using PyTorch's model saving
torch.save(model.state_dict(), "df3_DistilBERT_BiLSTM.pth")
...
# Save the best model using PyTorch's model saving
torch.save(model.state_dict(), "df3_BART_BiLSTM.pth")
...
# Save the best model using PyTorch's model saving
torch.save(model.state_dict(), "df3_ALBERT_BiLSTM.pth")
...
# Save the best model using PyTorch's model saving
torch.save(model.state_dict(), "df3_RoBERTa_BiLSTM.pth")
...
# Save the best model using PyTorch's model saving
torch.save(model.state_dict(), "df3_ELECTRA_BiLSTM.pth")
...
# Save the best model using PyTorch's model saving
torch.save(model.state_dict(), "df3_XLNET_BiLSTM.pth")
