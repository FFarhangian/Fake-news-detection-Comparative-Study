...
labels_train = df2_train_class.to_numpy().flatten()
labels_test = df2_test_class.to_numpy().flatten()
...
# Save the best model
joblib.dump(model, 'df2_ELMO_CNN.sav')
...
# Save the best model
joblib.dump(model, 'df2_BERT_CNN.sav')
...
# Save the best model
joblib.dump(model, 'df2_DistilBERT_CNN.sav')
...
# Save the best model
joblib.dump(model, 'df2_BART_CNN.sav')
...
# Save the best model
joblib.dump(model, 'df2_ALBERT_CNN.sav')
...
# Save the best model
joblib.dump(model, 'df2_RoBERTa_CNN.sav')
...
# Save the best model
joblib.dump(model, 'df2_ELECTRA_CNN.sav')
...
# Save the best model
joblib.dump(model, 'df2_XLNET_CNN.sav')
