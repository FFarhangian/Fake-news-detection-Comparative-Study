...
df2_Word2Vec_BiLSTM_pred = best_model.predict(data_test)
df2_Word2Vec_BiLSTM_pred_binary = np.where(df2_Word2Vec_BiLSTM_pred > 0.5, 1, 0)

# Evaluate performance on the test set
test_accuracy = accuracy_score(df2_test_class, df2_Word2Vec_BiLSTM_pred_binary)
print("Test Accuracy: %.2f%%" % (test_accuracy * 100))

# Save predictions and model
np.savetxt("df2_Word2Vec_BiLSTM_pred.csv", df2_Word2Vec_BiLSTM_pred_binary, delimiter=",")

# Save the best model using Keras' model saving
best_model.save("df2_Word2Vec_BiLSTM.h5")
...
# Save the best model using Keras' model saving
best_model.save("df2_Glove_BiLSTM.h5")
...
# Predict on the test set
df2_Fasttext_BiLSTM_pred = best_model.predict(data_test)
df2_Fasttext_BiLSTM_pred_binary = np.where(df2_Fasttext_BiLSTM_pred > 0.5, 1, 0)

# Evaluate performance on the test set
test_accuracy = accuracy_score(df2_test_class, df2_Fasttext_BiLSTM_pred_binary)
print("Test Accuracy: %.2f%%" % (test_accuracy * 100))

# Save predictions and model
np.savetxt("df2_Fasttext_BiLSTM_pred.csv", df2_Fasttext_BiLSTM_pred_binary, delimiter=",")

# Save the best model using Keras' model saving
best_model.save("df2_Fasttext_BiLSTM.h5")
...
feature_matrix_train = np.load('ELMO_df2_train.npz')['arr_0']
feature_matrix_test = np.load('ELMO_df2_test.npz')['arr_0']
...
torch.save(model.state_dict(), "df2_ELMO_BiLSTM.pth")
...
feature_matrix_train = np.load('BERT_df2_train.npz')['arr_0']
feature_matrix_test = np.load('BERT_df2_test.npz')['arr_0']
labels_train = df1_train_class.to_numpy().flatten()
labels_test = df1_test_class.to_numpy().flatten()
...
# Save the best model using PyTorch's model saving
torch.save(model.state_dict(), "df2_BERT_BiLSTM.pth")
...
feature_matrix_train = np.load('DistilBERT_df2_train.npz')['arr_0']
feature_matrix_test = np.load('DistilBERT_df2_test.npz')['arr_0']
labels_train = df1_train_class.to_numpy().flatten()
labels_test = df1_test_class.to_numpy().flatten()
...
# Save the best model using PyTorch's model saving
torch.save(model.state_dict(), "df2_DistilBERT_BiLSTM.pth")
...
feature_matrix_train = np.load('BART_df2_train.npz')['arr_0']
feature_matrix_test = np.load('BART_df2_test.npz')['arr_0']
labels_train = df1_train_class.to_numpy().flatten()
labels_test = df1_test_class.to_numpy().flatten()
...
# Save the best model using PyTorch's model saving
torch.save(model.state_dict(), "df2_BART_BiLSTM.pth")
...
feature_matrix_train = np.load('ALBERT_df2_train.npz')['arr_0']
feature_matrix_test = np.load('ALBERT_df2_test.npz')['arr_0']
labels_train = df1_train_class.to_numpy().flatten()
labels_test = df1_test_class.to_numpy().flatten()
...
# Save the best model using PyTorch's model saving
torch.save(model.state_dict(), "df2_ALBERT_BiLSTM.pth")
...
feature_matrix_train = np.load('RoBERTa_df2_train.npz')['arr_0']
feature_matrix_test = np.load('RoBERTa_df2_test.npz')['arr_0']
labels_train = df1_train_class.to_numpy().flatten()
labels_test = df1_test_class.to_numpy().flatten()
...
# Save the best model using PyTorch's model saving
torch.save(model.state_dict(), "df2_RoBERTa_BiLSTM.pth")
...
feature_matrix_train = np.load('ELECTRA_df2_train.npz')['arr_0']
feature_matrix_test = np.load('ELECTRA_df2_test.npz')['arr_0']
labels_train = df1_train_class.to_numpy().flatten()
labels_test = df1_test_class.to_numpy().flatten()
...
# Save the best model using PyTorch's model saving
torch.save(model.state_dict(), "df2_ELECTRA_BiLSTM.pth")
...
feature_matrix_train = np.load('XLNET_df2_train.npz')['arr_0']
feature_matrix_test = np.load('XLNET_df2_test.npz')['arr_0']
labels_train = df1_train_class.to_numpy().flatten()
labels_test = df1_test_class.to_numpy().flatten()
...
# Save the best model using PyTorch's model saving
torch.save(model.state_dict(), "df2_XLNET_BiLSTM.pth")
