...
df4_Word2Vec_CNN_pred = best_model.predict(data_test)
df4_Word2Vec_CNN_pred_classes = np.argmax(df4_Word2Vec_CNN_pred, axis=1) if activations != 'sigmoid' else np.where(df4_Word2Vec_CNN_pred > 0.5, 1, 0)

# Evaluate performance on the test set
test_accuracy = accuracy_score(df4_test_class, df4_Word2Vec_CNN_pred_classes)
print("Test Accuracy: %.2f%%" % (test_accuracy * 100))

# Save predictions and model
np.savetxt("df4_Word2Vec_CNN_pred.csv", df4_Word2Vec_CNN_pred_classes, delimiter=",")
joblib.dump(best_model, 'df4_Word2Vec_CNN.sav')
...
# Predict on the test set
df4_Glove_CNN_pred = best_model.predict(data_test)
df4_Glove_CNN_pred_classes = np.argmax(df4_Glove_CNN_pred, axis=1) if activations != 'sigmoid' else np.where(df4_Glove_CNN_pred > 0.5, 1, 0)

# Evaluate performance on the test set
test_accuracy = accuracy_score(df4_test_class, df4_Glove_CNN_pred_classes)
print("Test Accuracy: %.2f%%" % (test_accuracy * 100))

# Save predictions and model
np.savetxt("df4_Glove_CNN_pred.csv", df4_Glove_CNN_pred_classes, delimiter=",")
joblib.dump(best_model, 'df4_Glove_CNN.sav')
...
# Predict on the test set
df4_Fasttext_CNN_pred = best_model.predict(data_test)
df4_Fasttext_CNN_pred_classes = np.argmax(df4_Fasttext_CNN_pred, axis=1) if activations != 'sigmoid' else np.where(df4_Fasttext_CNN_pred > 0.5, 1, 0)

# Evaluate performance on the test set
test_accuracy = accuracy_score(df4_test_class, df4_Fasttext_CNN_pred_classes)
print("Test Accuracy: %.2f%%" % (test_accuracy * 100))

# Save predictions and model
np.savetxt("df4_Fasttext_CNN_pred.csv", df4_Fasttext_CNN_pred_classes, delimiter=",")
joblib.dump(best_model, 'df4_Fasttext_CNN.sav')
...
labels_train = df4_train_class.to_numpy().flatten()
labels_test = df4_test_class.to_numpy().flatten()
...
# Save the best model
joblib.dump(model, 'df4_ELMO_CNN.sav')
...
# Save the best model
joblib.dump(model, 'df4_BERT_CNN.sav')
...
# Save the best model
joblib.dump(model, 'df4_DistilBERT_CNN.sav')
...
# Save the best model
joblib.dump(model, 'df4_BART_CNN.sav')
...
# Save the best model
joblib.dump(model, 'df4_ALBERT_CNN.sav')
...
# Save the best model
joblib.dump(model, 'df4_RoBERTa_CNN.sav')
...
# Save the best model
joblib.dump(model, 'df4_ELECTRA_CNN.sav')
...
# Save the best model
joblib.dump(model, 'df4_XLNET_CNN.sav')
