...
DistilBert = AutoModel.from_pretrained(DistilBert_model_name)
...
class DistilBERT_Arch(nn.Module):
    ...
    def forward(self, sent_id, mask):
        cls_hs, = self.DistilBert(sent_id, attention_mask=mask)
...
np.savetxt("df1_DistilBERT_preds.csv", test_preds, delimiter=",")
