...
df1_Word2Vec_BiLSTM_pred = best_model.predict(data_test)
df1_Word2Vec_BiLSTM_pred_classes = np.argmax(df1_Word2Vec_BiLSTM_pred, axis=1)

# Evaluate performance on the test set
test_accuracy = accuracy_score(df1_test_class, df1_Word2Vec_BiLSTM_pred_classes)
...
# Predict on the test set
df1_Fasttext_BiLSTM_pred = best_model.predict(data_test)
df1_Fasttext_BiLSTM_pred_classes = np.argmax(df1_Fasttext_BiLSTM_pred, axis=1)

# Evaluate performance on the test set
test_accuracy = accuracy_score(df1_test_class, df1_Fasttext_BiLSTM_pred_classes)
print("Test Accuracy: %.2f%%" % (test_accuracy * 100))
