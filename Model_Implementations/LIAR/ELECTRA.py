...
# Define the ELECTRA model and tokenizer
electra_model_name = "google/electra-base-discriminator"
bart = AutoModel.from_pretrained(electra_model_name)
...
np.savetxt("df1_ELECTRA_preds.csv", test_preds, delimiter=",")
